const menu = {
  ...
  pages: document.querySelectorAll('.menuRowPages > h2'),
  info: document.querySelectorAll('.menuRowInfo > div > span'),
  title: document.querySelectorAll('.menuRowTitle > h1'),
  media: document.querySelector('.mediaRowMedia'),
};

const button = {
  element: document.querySelector('.navMenuButton'),
  text: document.querySelectorAll('.navMenuText > span'),
...
const initMenu = ()=> {
  gsap.set(menu.element, { pointerEvent: 'none', clipPath: clipPath.bottom });
